...
- (void)initWithPickerView {
    ...
    //设置返回默认值
    [self.rowArray addObject:_dataArray[0][0]];
    [self.rowArray addObject:_dataArray[1][0]];
...
- (void)pickerView:(UIPickerView *)pickerView didSelectRow:(NSInteger)row inComponent:(NSInteger)component {
    [self.rowArray replaceObjectAtIndex:component withObject:_dataArray[component][row]];
